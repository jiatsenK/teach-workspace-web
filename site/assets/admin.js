import { createLearningDataProvider } from './data-provider.js?v=c78cd8b';
import { publishLearningPlatformConfig, readLearningWriteStatus } from './learning-studio/config-client.js?v=c78cd8b';
