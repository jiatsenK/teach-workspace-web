import { createLearningDataProvider } from './data-provider.js?v=fe130c0';
import { publishLearningPlatformConfig, readLearningWriteStatus } from './learning-studio/config-client.js?v=fe130c0';
