import { createLearningDataProvider } from './data-provider.js?v=b93d42f';
import { publishLearningPlatformConfig, readLearningWriteStatus } from './learning-studio/config-client.js?v=b93d42f';
