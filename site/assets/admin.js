import { createLearningDataProvider } from './data-provider.js?v=3f0dec7';
import { publishLearningPlatformConfig, readLearningWriteStatus } from './learning-studio/config-client.js?v=3f0dec7';
