import { createLearningDataProvider } from './data-provider.js?v=c16ecbd';
import { publishLearningPlatformConfig, readLearningWriteStatus } from './learning-studio/config-client.js?v=c16ecbd';
