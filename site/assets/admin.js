import { createLearningDataProvider } from './data-provider.js?v=80292f1';
import { publishLearningPlatformConfig, readLearningWriteStatus } from './learning-studio/config-client.js?v=80292f1';
