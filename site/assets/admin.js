import { createLearningDataProvider } from './data-provider.js?v=7471a82';
import { publishLearningPlatformConfig, readLearningWriteStatus } from './learning-studio/config-client.js?v=7471a82';
