import { createLearningDataProvider } from './data-provider.js?v=24ee7aa';
import { publishLearningPlatformConfig, readLearningWriteStatus } from './learning-studio/config-client.js?v=24ee7aa';
