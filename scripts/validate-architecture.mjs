...
const activeModules = new Set([...activeEntrypoints, 'data-provider.js', 'learning-studio/course-context.js', 'learning-studio/config-client.js', 'learning-studio/note-client.js']);
